...
<template>
  ...
  <div class="bg-white rounded-lg shadow-md px-5">
    <div class="flex justify-between pt-6 pb-3">
      ...
      <button
        @click="navigateTo('visualnovel/config')"
        class="bg-slate-200 hover:bg-slate-100 focus:ring-4 focus:ring-slate-50 transition-colors text-gray-800 font-medium text-lg px-3 py-2 rounded-md shadow-sm" data-ripple-light="true" data-tooltip-target="tooltip-top-start"
      >
    ...
    <div class="py-3">
      <div class="flex justify-end">
        <div class="flex flex-row gap-x-5 pb-5 justify-self-end">
      ...
      <table v-if="isLoading" class="table-auto animate-pulse w-full">
        <tbody>
